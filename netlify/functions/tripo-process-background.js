                ...
                try {
                    ...
                    if (message.event === 'update') {
                        ...
                        if (finalStatus === 'success') {
                            ...
                            const previewUrl = outputData?.rendered_image;
                            ...
                            if (modelUrl) {
                                resolve({
                                    ...
                                    rawResult: { output: outputData }
                                });
                            } else {
                                console.error(`[tripo-process-background] ❌ 未找到模型URL，完整数据:`, JSON.stringify(message.data, null, 2));
